...
const Navbar = () => {
  ...
  return (
    <div className =' top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5 block'>
      ...
      <div  className={`max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium 
        ...
        <Link onClick = {() => {scroll(0,0); setIsOpen(false)}} to ={'/'}>Release</Link>
