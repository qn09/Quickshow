...
const FeaturedSection = () => {
  ...
  return (
    <div className='px-6 md:px-12 lg:px-16 xl:px-33 overflow-hidden'>
      <div className ='relative flex items-center justify-between pt-20 pb-10'>
        <BlurCircle top = '0' right ='-80px'></BlurCircle>
        <p className='text-gray-300 font-medium text-lg'>Now Streaming</p>
        <button onClick={() => navigate('/movies') } className='group flex items-center gap-2 text-sm text-gray-300'>
          View all <ArrowRight className='group-hover:translate-x-0.5 transition w-4.5 h-4.5'></ArrowRight>
        </button>
      </div>
